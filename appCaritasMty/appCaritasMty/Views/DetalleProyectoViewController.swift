...
class DetalleProyectoViewController: UIViewController {
    ...
    @IBOutlet weak var lbProjectNambre: UILabel!
    
    var projectReceived : projectList!=nil
    
    //var projectReceived : projectList
    ...
    override func viewDidLoad() {
        ...
        imgProject.image = projectReceived.projectImage
        lbProjectNambre.text = projectReceived.projectName
